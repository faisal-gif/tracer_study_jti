    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="instructor.html" class="nav-link">Alumni</a></li>
      ...
      <div class="row d-flex">
        <div class="col-lg-4 ftco-animate">
          <div class="blog-entry">
            <a href="blog-single.html" class="block-20" style="background-image: url('images/polinema3.jpg');">
            </a>
            <div class="text d-block">
              ...
              <h3 class="heading"><a href="#">Gedung Baru JTI Polinema</a></h3>
        ...
        <div class="col-lg-4 ftco-animate">
          <div class="blog-entry">
            <a href="blog-single.html" class="block-20" style="background-image: url('images/polinema4.jpg');">
            </a>
            <div class="text d-block">
              <div class="meta">
                <p>
              ...
              <h3 class="heading"><a href="#">Workshop Terbaru JTI Polinema</a></h3>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia...</p>
              <p><a href="blog.html" class="btn btn-secondary py-2 px-3">Read more</a></p>
            </div>
          </div>
        ...
        <div class="col-lg-4 ftco-animate">
          <div class="blog-entry">
            ...
            <div class="text d-block">
              ...
              <h3 class="heading"><a href="#">Penutupan DTS Polinema</a></h3>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia...</p>
              <p><a href="blog.html" class="btn btn-secondary py-2 px-3">Read more</a></p>
            </div>
          </div>
